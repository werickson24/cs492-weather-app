...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void getForecasts(location.Location currentLocation) async {
    List<forecast.Forecast> localForecast = await forecast.getForecastFromPoints(currentLocation.latitude, currentLocation.longitude);
    setState(() {
      _forecasts = localForecast;
    });
  }
      ...
      child: Center(
          child: Column(
            children: [
              ...
              forecastWidget(_forecasts.firstOrNull),
            ],
          ),
        ),
      ),
  ...
  Row forecastWidget(forecast.Forecast? localForecast) {
    return Row(
      children: [
        Text(
          localForecast?.shortForecast ?? "N/A",
